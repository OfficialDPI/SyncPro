    ...
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-[#070709] text-zinc-100 font-sans selection:bg-blue-500/30">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-[380px] flex-shrink-0 flex flex-col border-r border-zinc-800/60 overflow-hidden bg-[#08080a]">
          ...
          {/* Input */}
          <div className="flex-shrink-0 p-4 bg-[#08080a] border-t border-zinc-800/60">
            <div className="flex justify-between items-center px-1 mb-2">
              <div className="flex items-center gap-1.5">
                <Zap className="w-3.5 h-3.5 text-amber-500 fill-amber-500/20" />
                <span className="text-[10.5px] font-medium text-zinc-400">$209.7500 USD credits available</span>
              </div>
              <button className="text-[10.5px] font-semibold text-purple-400 hover:text-purple-300 transition-colors">
                Upgrade Now
              </button>
            </div>
            <div className="relative bg-[#141416] border border-zinc-800/80 rounded-2xl focus-within:border-blue-500/60 focus-within:ring-1 focus-within:ring-blue-500/20 transition-all shadow-lg">
              <textarea
                ref={textareaRef}
                className="w-full bg-transparent text-zinc-100 placeholder:text-zinc-500 px-4 pt-3.5 pb-12 outline-none resize-none text-sm leading-relaxed"
                placeholder="Plan, build, or ask a question... (Press Enter)"
                value={input}
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <button disabled={isStreaming} className="w-7 h-7 rounded-full bg-zinc-800 hover:bg-zinc-700 border border-zinc-700/60 text-zinc-400 hover:text-zinc-200 transition-colors flex items-center justify-center disabled:opacity-30">
                    <Plus className="w-4 h-4" />
                  </button>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-zinc-800/60 border border-zinc-700/60 text-zinc-300 text-[11px] font-medium cursor-pointer hover:bg-zinc-800 transition-colors">
                    <span>Sync 1.0 Lite</span>
                    <ChevronRight className="w-3 h-3 text-zinc-500 rotate-90" />
                  </div>
                  <div className="flex items-center px-3 py-1.5 rounded-full bg-zinc-800/60 border border-zinc-700/60 text-zinc-300 text-[11px] font-medium cursor-pointer hover:bg-zinc-800 transition-colors">
                    Agent
                  </div>
                </div>
                <button
                  ...
                  className="h-8 w-8 rounded-full bg-blue-600 hover:bg-blue-500 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-colors flex-shrink-0 text-white"
                >
                  {isStreaming
                    ? <Loader2 className="w-4 h-4 text-white animate-spin" />
                    : <svg className="w-4 h-4 transform rotate-45" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-center text-[10px] text-zinc-700 mt-2">
              Sync AI · DeepSeek deepseek-v4-pro · ⏎ send · ⇧⏎ newline
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 p-3 flex flex-col overflow-hidden bg-[#070709]">
          ...
          {activeTab === "preview" && (
            <div className="flex-1 flex flex-col overflow-hidden bg-[#0c0c0e] border border-zinc-800/80 rounded-[20px] shadow-2xl">
              ...
              {/* iFrame */}
              <div className="flex-1 bg-[#0b0f17] overflow-hidden relative h-full">
                {isStreaming ? (
